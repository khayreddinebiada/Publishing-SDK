        ...
        private static void InitAPI()
        {
            try
            {
                ...
                if(_settings == null)
                {
                    ...
                    if(!Directory.Exists(Application.dataPath + "/_SDK/Resources"))
                    {
                        Directory.CreateDirectory(Application.dataPath + "/_SDK/Resources");
                    }
                    if(!Directory.Exists(Application.dataPath + "/_SDK/Resources/GameAnalytics"))
                    {
                        Directory.CreateDirectory(Application.dataPath + "/_SDK/Resources/GameAnalytics");
                        Debug.LogWarning("GameAnalytics: _SDK/Resources/GameAnalytics folder is required to store settings. it was created ");
                    }

                    const string path = "Assets/_SDK/Resources/GameAnalytics/Settings.asset";
